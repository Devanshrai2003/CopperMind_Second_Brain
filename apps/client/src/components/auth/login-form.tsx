      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-copper-1000">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute inset-y-0 right-0 pr-3 flex items-center text-copper-1000 hover:text-amber-400 cursor-pointer"
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full bg-accent-700 hover:bg-accent-800 cursor-pointer text-text-on-dark py-2 px-4 rounded-lg transition-colors flex items-center justify-center"
          >
